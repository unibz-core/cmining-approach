...
#python3 -m cProfile e3_trial1.py > test.txt
#snakeviz p0.prof
...
if __name__ == "__main__":
    ...
    edge_labels = ["isComplete", "isDisjoint", "restrictedTo"] #utils.command.filterEdges()
...
# ###
    ...
    gsParameters = [10,3] #utils.command.parameters()
    ...
    similarity_threshold = float(0.1) #utils.command.ask_similarity_threshold()
